      ...
      <div className="flex flex-col md:flex-row gap-12">
        <aside className="w-full md:w-1/5">
          <nav className="flex flex-col space-y-1">
            <Link href="#" className="font-semibold text-primary px-3 py-2 rounded-md text-sm">Settings</Link>
            <Link href="#" className="text-muted-foreground hover:text-foreground px-3 py-2 rounded-md text-sm">Credits</Link>
            <Link href="#" className="text-muted-foreground hover:text-foreground px-3 py-2 rounded-md text-sm">Presets</Link>
            <Link href="#" className="text-muted-foreground hover:text-foreground px-3 py-2 rounded-md text-sm">API Keys</Link>
            <Link href="#" className="text-muted-foreground hover:text-foreground px-3 py-2 rounded-md text-sm">Provisioning Keys</Link>
            <Link href="#" className="text-muted-foreground hover:text-foreground px-3 py-2 rounded-md text-sm">Integrations (BYOK)</Link>
            <Link href="#" className="text-muted-foreground hover:text-foreground px-3 py-2 rounded-md text-sm">Privacy</Link>
          </nav>
        </aside>
